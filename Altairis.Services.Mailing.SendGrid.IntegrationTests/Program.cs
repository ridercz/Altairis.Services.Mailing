...
class Program {
    ...
    private static async Task SendPlainTextMail_Test() {
        ...
        var msg = new MailMessage {
            ...
            Subject = "Ĺ˝luĹĄouÄŤkĂ˝ kĹŻĹ ĂşpÄ›l ÄŹĂˇbelskĂ© Ăłdy - subject",
            Body = "Ĺ˝luĹĄouÄŤkĂ˝ kĹŻĹ ĂşpÄ›l ÄŹĂˇbelskĂ© Ăłdy - text."
        };
    ...
    private static async Task SendHtmlMail_Test() {
        ...
        var msg = new MailMessage {
            From = new MailAddress("sender@rider.cz", "Example Sender"),
            Subject = "Ĺ˝luĹĄouÄŤkĂ˝ kĹŻĹ ĂşpÄ›l ÄŹĂˇbelskĂ© Ăłdy - subject",
            Body = "<html><body><p>Ĺ˝luĹĄouÄŤkĂ˝ kĹŻĹ ĂşpÄ›l ÄŹĂˇbelskĂ© Ăłdy <b>v HTML</b>.</p></body></html>",
            IsBodyHtml = true
        };
        msg.To.Add(new MailAddress("ponyboy@email.cz", "Example Recipient"));
        await mx.SendMessageAsync(msg);
    ...
    private static async Task SendAlternateMail_Test() {
        ...
        msg.AlternateViews.Add(AlternateView.CreateAlternateViewFromString("<html><body><p>Ĺ˝luĹĄouÄŤkĂ˝ kĹŻĹ ĂşpÄ›l ÄŹĂˇbelskĂ© Ăłdy <b>v HTML</b>.</p></body></html>", Encoding.UTF8, "text/html"));
        msg.To.Add(new MailAddress("ponyboy@email.cz", "Example Recipient"));
        await mx.SendMessageAsync(msg);
    }
    ...
    private static async Task SendMailWithOptions_Test() {
        ...
        msg.AlternateViews.Add(AlternateView.CreateAlternateViewFromString("<p>Ĺ˝luĹĄouÄŤkĂ˝ kĹŻĹ ĂşpÄ›l ÄŹĂˇbelskĂ© Ăłdy <b>v HTML</b>.</p>", Encoding.UTF8, "text/html"));
        msg.To.Add(new MailAddress("ponyboy@email.cz", "Example Recipient"));
